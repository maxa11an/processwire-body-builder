...
(function($) {
    ...
    $.fn.asmSelect = function(customOptions) {
        ...
        var options = {
            ...
            lockedLabel: '<span class="asmIcon asmIconLocked"><i class="fa fa-lock"></i></span>', // Text used in the "remove" link
            ...
            lockedClass: 'asmListItemLocked',           // Class given to the "remove" link
        ...
        return this.each(function(index) {
            ...
            function addListItem(optionId) {
                ...
                var isNotDeletable = $O.attr('data-NotDeletable') == "true";

                var $removeLink = null;
                if(options.deletable && !isNotDeletable) $removeLink = $("<a></a>")
                    .attr("href", "#")
                ...
                if(isNotDeletable) $removeLink = $("<a></a>")
                    .attr("href", "#")
                    .addClass(options.lockedClass)
                    .prepend(options.lockedLabel);
